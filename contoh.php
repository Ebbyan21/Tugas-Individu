...
<div class="container mt-5">
    ...
    <form action="contoh2.php" method="post" class="needs-validation" novalidate>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="nilai1" class="form-label">Nilai Tugas 1:</label>
            <input type="number" class="form-control" id="nilai1" name="nilai1" min="0" max="100" required>
        </div>
        <div class="mb-3">
            <label for="nilai2" class="form-label">Nilai Tugas 2:</label>
