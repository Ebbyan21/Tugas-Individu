...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="document.getElementById('contentFrame').src='h0me.php';">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="document.getElementById('contentFrame').src='tugas_ganjil.php';">Tugas Ganjil</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- Sidebar and Content -->
    <div class="d-flex">
        <div class="bg-primary min-vh-100 p-3" style="width: 250px;">
